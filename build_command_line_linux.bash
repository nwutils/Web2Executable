...
rm -rf build Web2ExeLinux*

VERSION=$(cat files/version.txt)

pyinstaller --onefile --exclude-module PyQt5 --exclude-module PyQt4 --hidden-import PIL.Jpeg2KImagePlugin --hidden-import pkg_resources --hidden-import PIL._imaging --hidden-import configobj --distpath Web2ExeLinux-CMD -n web2exe-linux command_line.py
...
rm -rf Web2ExeLinux
pyinstaller -F --exclude-module PyQt5 --exclude-module PyQt4 --hidden-import PIL.Jpeg2KImagePlugin --hidden-import configobj --hidden-import PIL._imaging --hidden-import pkg_resources -n web2exe --distpath Web2ExeLinux main.py
